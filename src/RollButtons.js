...
const RollButtons = () =>  {
  ...
  <div className="flex h-screen items-center">
    <div className="bg-gray-900 rounded-tr-lg rounded-br-lg z-10">
      <div className="bg-blue-800 flex px-2 py-1 rounded-lg m-3 shadow-inner justify-around items-center">
        <p className="text-lg font-bold text-gray-300">Player 1</p>
